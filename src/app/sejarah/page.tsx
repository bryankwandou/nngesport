      ...
      <section className="container-page py-20 md:py-28">
        <Reveal gap={0.09}>
          <ol className="relative">
            ...
            <span
              aria-hidden
              className="absolute left-[7px] top-2 bottom-2 w-px bg-linear-to-b from-violet-500/70 via-white/10 to-transparent md:left-[calc(120px+7px)]"
            />
            ...
            {timeline.map((t) => (
              <RevealItem key={`${t.year}-${t.title}`} as="li">
                <article className="group relative grid gap-4 pb-14 pl-9 md:grid-cols-[120px_1fr] md:gap-10 md:pl-0">
                  ...
                  <span
                    aria-hidden
                    className="absolute left-0 top-2 grid h-[15px] w-[15px] place-items-center rounded-full border border-violet-500/50 bg-ink-950 transition-all duration-300 group-hover:border-cyan-400 md:left-[120px]"
                  >
                    <span className="h-[5px] w-[5px] rounded-full bg-violet-500 transition-colors duration-300 group-hover:bg-cyan-400" />
                  </span>
